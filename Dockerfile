...
RUN apt-get -y update --fix-missing \
    ...
    && cd /opt \
    # Download hadoop.
    && wget -O hadoop-${HADOOP_VERSION}.tar.gz http://mirrors.whoishostingthis.com/apache/hadoop/common/hadoop-${HADOOP_VERSION}/hadoop-${HADOOP_VERSION}.tar.gz \
    ...
    && mv /opt/config/docker_entrypoint.sh /root/ \
    && chmod a+x /root/docker_entrypoint.sh && chmod -R +x /opt \
...
EXPOSE 2181  9000  50070 50470 50075 50475 50010 50020 50090 50090 50100 50105 8485 8480 8481 50060  50030  19888 10033  10020 8032 8030 8088 8090  8031 8033  8040 8042 10200 8188 8190 8047 8788 8046 8045 22
